      ...
      <section id="contact" className="py-24 bg-white">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="bg-gradient-to-br from-blue-50 to-slate-50 p-8 md:p-12 rounded-3xl shadow-sm border border-blue-100 text-center">
            ...
            <button 
              onClick={openContactForm}
              className="w-full md:w-auto bg-amber-500 hover:bg-amber-600 text-white text-lg font-bold px-12 py-4 rounded-full shadow-lg shadow-amber-500/20 transition-all transform hover:scale-105"
            >
              無料診断・相談を申し込む
            </button>
          </div>
